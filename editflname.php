...
<?php
if (isset($_POST['updateflname'])) {
	$fname = $_POST['fname'];
	$lname = $_POST['lname'];
	
	$update = "UPDATE user SET firstname = '$fname', lastname = '$lname' WHERE id = 0";
...
<html>
    ...
    <body>
		...
		<div class="profileimgwrapper">
			...
			<form method="post" action="editflname.php" id="profileform">
				<p>First Name: <input type="text" name="fname"></p>
				<p>Last Name: <input type="text" name="lname"><p>
				<input type="submit" name="updateflname" value="Confirm" class="profilebuttons"=>
			</form>
